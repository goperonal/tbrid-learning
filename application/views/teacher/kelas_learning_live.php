<div class="wrapper containers">
  <div id="main" class="row">
    ...
    <div id="content" class="col-sm-10">
      ...
      <!-- LIVE ZOOM HERE -->
      <?php $this->load->view("teacher/live_zoom"); ?>

      <div id="content-list" class="row" style=" margin-top: 48px;">
            ...
            <div id="learning-box" class="">
              <div class="col-12">
                <?php echo form_open("#",array("id"=>"form_add_learning","class"=>"mt-4")); ?>
                  ...
                  <div class="form-group">
                    <label class="font-weight-normal" for="tampil">Show In Student</label>
                    <select class="form-control" name="tampil" id="tampil" style="max-width: 20%;">
                      <option value="yes" <?php echo !empty($learning->tampil) == "yes"?"selected":""; ?> >Yes</option>
                      <option value="no" <?php echo !empty($learning->tampil) == "no"?"selected":""; ?> >No</option>
                    </select>
                    <span id="tampil_error" class="text-danger"></span>
                  </div>

                  <button type="button" id="submit_learning" class="btn btn-info btn-sm btn-sm">Submit</button>
                </form>
              </div>
