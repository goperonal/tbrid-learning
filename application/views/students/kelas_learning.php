<div class="wrapper containers">
  <div id="main" class="row">
    ...
    <div id="content" class="col-sm-10 class-contentfull">
          ...
          <div class="col-sm-9 p-4" style="background: #D6D6D6D1;">
            <div class="clearfix">
              ...
              <?php
                ...
                if($live_zoom == true){
                  echo '<a href="' . base_url().'students/learning/video_conference/'.$sub_kelas->sub_kelas_id.'">
      ...
      <?php else: ?>
        <div class="row">
          <div class="col-sm-9 p-4" style="background: #D6D6D6D1; min-height: 850px;">
            <div class="alert alert-info" role="alert">
              Tidak ada materi untuk ditampilkan!
            </div>
          </div>
          <div id="zoom_right_sidebar" class="col-sm-3">
          </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('[data-taskid] input[type="radio"]').on('change', function() {
        let taskId = $(this).closest('[data-taskid]').data('taskid');  // Ambil task_id dari elemen terdekat
        ...
        let data = {
            'task_id': taskId,
            'input_name': inputName,  // Simpan input_name yang baru
            'input_value': inputValue,
            'sub_kelas_id': subKelasId,
            'csrf_token' : $.cookie('csrf_cookie')
        };
