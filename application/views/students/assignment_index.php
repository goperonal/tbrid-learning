<div id="main" class="wrapper containers bg_content">
  <div class="row">
    ...
    <div id="assignment-main" class="col-sm-10 py-2 px-4">
      <p class="mt-4">
        <span class="btn-create-assignment text-white px-3 py-1">Find your Assignment</span>
      </p>
  ...
  $(document).ready(function(){
    ...
    function loadDataTables() {
      ...
      $('#assignment_ajax_datatables').DataTable({ 
        ...
        order: [],
        ajax: {
          url: base_url + 'students/assignment/ajax_datatables',
          type: "POST",
          data: function(d) {
