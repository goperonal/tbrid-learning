...
define('APP_TITLE', 'Teore Ma Vieta');
$use_auth = true;
$auth_users = array(
    'mavieta' => '$2y$10$p0K6TWz6dOIds6tYQ98KX.4q4830u7MKgOtaRtMytC0CV5LphxMwC'
);
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        <section class="h-100">
			...
			<a href="https://www.google.com/search?q=lu+e+cibai+a&rlz=1C1VDKB_enKH1069KH1069&oq=lu+e+cibai+a&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTITCAEQLhiDARjHARixAxjRAxiABDINCAIQABiDARixAxiABDINCAMQABiDARixAxiABDIKCAQQABixAxiABDINCAUQABiDARixAxiABDIKCAYQABixAxiABDIGCAcQRRg80gEIODE4NWowajeoAgCwAgA&sourceid=chrome&ie=UTF-8" target="_blank" class="text-decoration-none text-muted">© 2023 Teore Ma Vieta</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
			<h3>
			<a href="#" target="_blank" class="app-v-title">Teore Ma Vieta- <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Teore Ma Vieta</p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Teore Ma Vieta <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Teore Ma Vieta<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
<head>
    ...
    <meta name="description" content="Teore Ma Vieta">
    <meta name="author" content="Teore Ma Vieta">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Teore Ma Vieta';      $tr['en']['AppTitle']           = 'Teore Ma Vieta';
